...
public abstract class DimensionInfo
{
  ...
  public final GridConstraints getConstraints(int componentIndex) { return this.myLayoutState.getConstraints(componentIndex); }
  ...
  public final int getCell(int componentIndex) { return this.myCell[componentIndex]; }
  ...
  public final int getGap() { return this.myGap; }
